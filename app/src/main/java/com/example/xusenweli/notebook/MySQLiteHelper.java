...
public class MySQLiteHelper extends SQLiteOpenHelper {
    public static final String TABLE_NOTES = "notes";                 // a constant for the TABLE_FISH table name
    /**
    ...
    private static final String DATABASE_NAME = "noting.db";     // constant for the database name
